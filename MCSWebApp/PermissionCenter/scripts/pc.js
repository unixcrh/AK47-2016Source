    ...
    pcHelper.popups = {
        ...
        newMember: function (obj) {
            ...
            if (obj.nodeType && obj.nodeType === 1) //DOM，从元素上查找参数
            {
                ...
                result = doPop(schema, parent, null);
            }
            else if (typeof obj === "string")
                result = doPop(obj, null, null);
        ...
        batchProperties: function (gridId) {
            ...
            if (grid) {
                event.returnValue = pcHelper.showDialog(pcHelper.appRoot + "dialogs/BatchEditorIntro.htm", grid.get_clientSelectedKeys(), null, false, 900, 600, true);
