...
namespace MCS.Dynamics.Web
{
	public static class Util
	{
        ...
        public static bool SuperVisiorMode
        {
            ...
            {
                //return true;
                return DEPrincipalExtension.IsSupervisor(DeluxePrincipal.Current);
            }
        }
        ...
        //        success = PC.Adapters.SchemaObjectAdapter.Instance.LoadByCodeName(schemaType, newName, DateTime.MinValue) == null;
        //    }
        //    while (success == false);
		...
		internal static InvokeWebServiceJob CreateImmediateJob(string jobID, string name, string category, string url, string methodName, WfServiceOperationParameterCollection parameters)
		{
			...
			serviceDef.Timeout = TimeSpan.FromDays(1);
