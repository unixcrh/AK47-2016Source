<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ETLEntityMappingDialog.aspx.cs"
    Inherits="MCS.Dynamics.Web.Pages.ETL.Dialogs.ETLEntityMappingDialog" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        var urllocation = "OuterETLEntityMapping.aspx";
                            ...
                            <div style="height: 100%; width: 100%">
                                ...
                                <div class="dialogContent">
                                    ...
                                    <soa:DeluxeObjectDataSource ID="dataSourceMain" runat="server" EnablePaging="True"
                                        TypeName="MCS.Dynamics.Web.DataSource.ETLEntityMappingDataSource" EnableViewState="false"
