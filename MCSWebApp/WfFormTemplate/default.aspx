...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function onStartSelectedProcessForDynamicForm() {
            event.returnValue = false;
            ...
            if (result) {
                ...
                if (processDescList.length > 0) {
                    ...
                    window.open("Forms/DynamicFormController.ashx?processDescKey=" + key, "_blank", 'height=600px, width=800px, top=100, left=300, toolbar=no, menubar=no, scrollbars=no, resizable=yes,location=no, status=no');
                }
            }
...
<body>
    <form id="serverForm" runat="server">
        ...
        <div>
            <ul>
                <li><a href="Forms/TemplateController.ashx" target="selectApprover" onclick="onStartFreeProcess()">启动动态流程</a></li>
                ...
                <li><a href="#" target="selectExistsProcess" onclick="onStartSelectedProcess()">启动已存在的流程</a></li>
                <li><a href="#" target="selectDynamicForm" onclick="onStartSelectedProcessForDynamicForm()">使用动态表单启动已存在的流程</a></li>
            </ul>
        </div>
        <div style="height: 40px">
        </div>
