...
ace.handle_side_menu = function (a) {
    ...
    a(".nav-list").on(ace.click_event, function (h) {
        ...
        if (!a(f).is(":visible")) {
            ...
            if (c && d.hasClass("nav-list")) { return } d.find("> .open > .submenu").each(function () {
                if (this != f && !a(this.parentNode).hasClass("active")) { a(this).slideUp(200).parent().removeClass("open") }
            })
        } else {
        }

        if (c && a(f.parentNode.parentNode).hasClass("nav-list")) { return false } a(f).slideToggle(200).parent().toggleClass("open");
        return false
    })
};

ace.handle_setting_box = function (a) {
...
ace.widget_boxes = function (a) {
    ...
    a(document).on("click.ace.widget", "[data-action]", function (o) {
        o.preventDefault();
        var n = a(this); var p = n.data("action"); var b = n.closest(".widget-box");
            ...
            if (p == "close") {
                ...
                if (p == "reload") {
                    ...
                    b.one("reloaded.ace.widget", function () {
                        ...
                        if (q) { b.removeClass("position-relative") }
                    })
                } else {
                    if (p == "settings") {
...
ace.switch_direction = function (d) {
    ...
    c.toggleClass("rtl")
        ...
        .find(".pull-right:not(.dropdown-menu,blockquote,.profile-skills .pull-right)").removeClass("pull-right").addClass("tmp-rtl-pull-right").end()
        .find(".pull-left:not(.dropdown-submenu,.profile-skills .pull-left)").removeClass("pull-left").addClass("pull-right").end()
        .find(".tmp-rtl-pull-right").removeClass("tmp-rtl-pull-right").addClass("pull-left").end()
        .find(".chosen-container").toggleClass("chosen-rtl").end();
