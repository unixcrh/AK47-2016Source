...
ace.settings = {
    ...
    breadcrumbs_fixed: function (a) {
        a = a || false; if (a && !ace.settings.is("sidebar", "fixed")) {
    ...
    sidebar_collapsed: function (c) {
        ...
        if (c) {
            ...
            ace.removeClass(d, a); ace.addClass(d, b);
    ...
    this.set = function (h, g, i, k) {
        ...
        if (i === k) {
            ...
            if (a == 1) {
                ...
                if (a == 2) {
                    var j = d.get(b + h); var f = j ? JSON.parse(j) : {};
                    if (i == null) {
                        delete f[g];
                        if (ace.sizeof(f) == 0) {
                            d.remove(b + h); return
...
ace.cookie = {
    ...
    set: function (b, e, a, g, c, f) {
        ...
        if (typeof (a) == "object" && a.toGMTString) {
            ...
            if (parseInt(a, 10)) {
                h.setTime(h.getTime() + (parseInt(a, 10) * 1000)); a = h.toGMTString()
            } else {
                a = "";
            }
        }
...
ace.toggleClass = function (b, a) {
    if (ace.hasClass(b, a)) { ace.removeClass(b, a) } else { ace.addClass(b, a) }
};
