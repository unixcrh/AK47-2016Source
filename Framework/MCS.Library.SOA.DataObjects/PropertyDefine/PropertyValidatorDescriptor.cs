...
namespace MCS.Library.SOA.DataObjects
{
    ...
    public class PropertyValidatorDescriptor : IXElementSerializable
    {
        ...
        public ClientVdtAttribute ToClientVdtAttribute()
        {
            ClientVdtAttribute cvAttr = new ClientVdtAttribute();

            cvAttr.MessageTemplate = this.MessageTemplate;

            if (this.GetValidator() is IClientValidatable)
            {
                cvAttr.ClientValidateMethodName =
                    ((IClientValidatable)this.GetValidator()).ClientValidateMethodName;
            }
