...
[assembly: WebResource("MCS.Web.Responsive.WebControls.DataBinding.DataBindingControl.js", "application/x-javascript")]
...
namespace MCS.Web.Responsive.WebControls
{
    ...
    [ClientScriptResource("MCS.Web.WebControls.DataBindingControl", "MCS.Web.Responsive.WebControls.DataBinding.DataBindingControl.js")]
    [ToolboxData("<{0}:DataBindingControl runat=server></{0}:DataBindingControl>")]
    public class DataBindingControl : ScriptControlBase
    {
        ...
        {
            this.validatorAttributes = new List<ClientVdtData>();
        }
        ...
        public bool AutoBinding
        {
            get
            {
                return ViewState.GetViewStateValue("AutoBinding", true);
            }
            set
            {
                ViewState.SetViewStateValue("AutoBinding", value);
            }
        }
        ...
        public string DataTypeName
        {
            get
            {
                return ViewState.GetViewStateValue("DataTypeName", string.Empty);
            }
            set
            {
                ViewState.SetViewStateValue("DataTypeName", value);
                this._dataType = null;
            }
        }
        ...
        public bool AutoValidate
        {
            get
            {
                return ViewState.GetViewStateValue("AutoValidate", true);
            }
            set
            {
                ViewState.SetViewStateValue("AutoValidate", value);
            }
        }
        ...
        public bool IsValidateChildren
        {
            get
            {
                return ViewState.GetViewStateValue("IsValidateChildren", false);
            }
            set
            {
                ViewState.SetViewStateValue("IsValidateChildren", value);
            }
        }
        ...
        public bool AutoCollectDataWhenPostBack
        {
            get
            {
                return ViewState.GetViewStateValue("AutoCollectDataWhenPostBack", true);
            }
            set
            {
                ViewState.SetViewStateValue("AutoCollectDataWhenPostBack", value);
            }
        }
        ...
        public bool AllowClientCollectData
        {
            get
            {
                return ViewState.GetViewStateValue("AllowClientCollectData", false);
            }
            set
            {
                ViewState.SetViewStateValue("AllowClientCollectData", value);
            }
        }
        ...
        public bool IsValidateOnSubmit
        {
            get
            {
                return ViewState.GetViewStateValue("IsValidateOnSubmit", false);
            }
            set
            {
                ViewState.SetViewStateValue("IsValidateOnSubmit", value);
            }
        }
        ...
        public bool ValidateUnbindProperties
        {
            get
            {
                return ViewState.GetViewStateValue("ValidateUnbindProperties", true);
            }
            set
            {
                ViewState.SetViewStateValue("ValidateUnbindProperties", value);
            }
        }
        ...
        private void MappingDataToValidate()
        {
            foreach (DataBindingItem item in this.ItemBindings)
            {
                ClientVdtData cvtData = new ClientVdtData();

                cvtData.IsValidateOnSubmit = this.IsValidateOnSubmit;
                cvtData.FormatString = item.Format;
                cvtData.ValidationGroup = item.ValidationGroup;
                cvtData.ClientIsHtmlElement = item.ClientIsHtmlElement;
                cvtData.DataPropertyName = item.DataPropertyName;
                ...
                cvtData.ControlID = vdtControl.ClientID;
                ...
                {
                    cvtData.IsFloat = true;
                }

                cvtData.ValidateProp = item.ClientPropName.Length > 0 ? item.ClientPropName : "value";

                if (propertyinfo.PropertyType == typeof(string))
                    cvtData.IsValidateOnBlur = false;	//字符串禁止使用客户端焦点移开的校验，沈峥修改
                else
                    cvtData.IsValidateOnBlur = item.IsValidateOnBlur;

                vobjects = propertyinfo.GetCustomAttributes(typeof(ValidatorAttribute), true);

                if (vobjects.Length <= 0 && !cvtData.IsFloat && !cvtData.IsOnlyNum)
                    continue;
                ...
                this.validatorAttributes.Add(cvtData);
            }
        }
