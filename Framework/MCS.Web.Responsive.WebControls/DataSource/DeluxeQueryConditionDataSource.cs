...
namespace MCS.Web.Responsive.WebControls
{
    ...
    public class DeluxeQueryConditionDataSource : DeluxeObjectDataSource
    {
        ...
        {
            this.TypeName = "MCS.Web.Responsive.WebControls.DeluxeQueryInnerDataSourceAdapter";
        ...
        public string Connection
        {
            get
            {
                return ViewState.GetViewStateValue("Connection", string.Empty);
            }
            set
            {
                ViewState.SetViewStateValue("Connection", value);
            }
        }
        ...
        public string SelectFields
        {
            get
            {
                return ViewState.GetViewStateValue("SelectFields", string.Empty);
            }
            set
            {
                ViewState.SetViewStateValue("SelectFields", value);
            }
        }
        ...
        public string OrderByClause
        {
            get
            {
                return ViewState.GetViewStateValue("OrderByClause", string.Empty);
            }
            set
            {
                ViewState.SetViewStateValue("OrderByClause", value);
            }
        }
        ...
        public string WhereClause
        {
            get
            {
                return ViewState.GetViewStateValue("WhereClause", string.Empty);
            }
            set
            {
                ViewState.SetViewStateValue("WhereClause", value);
            }
        }
        ...
        public string TableName
        {
            get
            {
                return ViewState.GetViewStateValue("TableName", string.Empty);
            }
            set
            {
                ViewState.SetViewStateValue("TableName", value);
            }
        }
