...
namespace MCS.Web.Library.MVC
{
    ...
    public class Scene
    {
        ...
        public static void RenderAllChildrenReadOnly(Control rootControl, bool isReadOnly)
        {
            InnerFindAllChildrenControls(rootControl, (control) => GetRegisteredRender(control.GetType()).RenderReadOnly(control, isReadOnly));
        }
        ...
        public static void RenderAllChildrenEnabled(Control rootControl, bool enabled)
        {
            InnerFindAllChildrenControls(rootControl, (control) => GetRegisteredRender(control.GetType()).RenderEnabled(control, enabled));
        }
        ...
        public static void RenderAllChildrenVisible(Control rootControl, bool visible)
        {
            InnerFindAllChildrenControls(rootControl, (control) => GetRegisteredRender(control.GetType()).RenderVisible(control, visible));
        }

        private static void InnerFindAllChildrenControls(Control parentControl, Action<Control> action)
        {
            foreach (Control control in parentControl.Controls)
            {
                InnerFindAllChildrenControls(control, action);
                action(control);
            }
        }
