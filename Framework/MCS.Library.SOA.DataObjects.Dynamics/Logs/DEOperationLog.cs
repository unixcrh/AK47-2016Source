...
{
	[Serializable]
	[ORTableMapping("DE.OperationLog")]
	public class DEOperationLog
	{
		/// <summary>
		/// 根据环境信息初始化Log。
		...
		public DEOperationType OperationType { get; set; }
	...
	[Serializable]
	public class DEOperationLogCollection : EditableDataObjectCollectionBase<DEOperationLog>
	{
	}
}
