...
namespace MCS.Library.SOA.DataObjects.Dynamics.Organizations
{
	...
	/// </summary>
	[Serializable]
	[ORTableMapping("DE.SchemaMembers")]
	public abstract class DESimpleRelationBase : DESchemaObjectBase
	{
		[NonSerialized]
		private DESchemaObjectBase _Container = null;

		[NonSerialized]
		private DESchemaObjectBase _Member = null;

		/// <summary>
		/// 初始化<see cref="DEMemberRelation"/>的新实例
		/// </summary>
		public DESimpleRelationBase(string schemaType) :
			base(schemaType)
		{
		}
		...
		public DESimpleRelationBase(DESchemaObjectBase container, DESchemaObjectBase member, string schemaType) :
			base(schemaType)
		{
		...
		public DESchemaObjectBase Container
		{
			get
			{
				...
				{
                    this._Container = DESchemaObjectAdapter.Instance.Load(this.ContainerID);
		...
		[ScriptIgnore]
		[NoMapping]
		public DESchemaObjectBase Member
		{
			get
			{
				if (this._Member == null && this.ID.IsNotEmpty())
				{
                    this._Member = DESchemaObjectAdapter.Instance.Load(this.ID);
	...
	/// </summary>
	[Serializable]
    public class DEMemberRelationCollection : DESchemaObjectCollectionBase<DESimpleRelationBase, DEMemberRelationCollection>
	{
		protected override DEMemberRelationCollection CreateFilterResultCollection()
		{
			return new DEMemberRelationCollection();
		}
	}
	...
	/// </summary>
	[Serializable]
	public abstract class DEMemberRelationCollectionBase : DESchemaObjectEditableKeyedCollectionBase<DESimpleRelationBase, DEMemberRelationCollectionBase>
	{
		/// <summary>
		/// 获取根据关系类型过滤的结果集合
		/// </summary>
		/// <param name="schemaType"></param>
		/// <returns></returns>
		public DEMemberRelationCollectionBase FilterBySchemaType(string schemaType)
		{
			DEMemberRelationCollectionBase result = CreateFilterResultCollection();

			foreach (DESimpleRelationBase mr in this)
			{
		...
		/// <param name="schemaType"></param>
		/// <returns></returns>
		public DEMemberRelationCollectionBase FilterByContainerSchemaType(string schemaType)
		{
			DEMemberRelationCollectionBase result = CreateFilterResultCollection();
		...
		/// <returns><see cref="DEMemberRelationCollectionBase"/>对象</returns>
		public DEMemberRelationCollectionBase FilterByMemberSchemaType(string schemaType)
		{
			DEMemberRelationCollectionBase result = CreateFilterResultCollection();
	...
	/// </summary>
	[Serializable]
	public class DEObjectContainerRelationCollection : DEMemberRelationCollectionBase
	{
		...
		protected override string GetKeyForItem(DESimpleRelationBase item)
		{
			return item.ContainerID;
		}

		protected override DEMemberRelationCollectionBase CreateFilterResultCollection()
		{
			return new DEObjectContainerRelationCollection();
		}
	}
	...
	/// </summary>
	[Serializable]
	public class DEObjectMemberRelationCollection : DEMemberRelationCollectionBase
	{
		...
		/// 获取集合中指定对象的键
		/// </summary>
		/// <param name="item">要获取其键的<see cref="DEMemberRelation"/>对象</param>
		/// <returns></returns>
		protected override string GetKeyForItem(DESimpleRelationBase item)
		{
			return item.ID;
		...
		protected override DEMemberRelationCollectionBase CreateFilterResultCollection()
		{
			return new DEObjectMemberRelationCollection();
		}
	}
