...
namespace MCS.Web.Library
{
    ...
    public static class WebUtility
    {
        ...
        {
            RefreshParentWindow("refresh", RefreshParentWindowName.Opener);
        }
        ...
        /// <param name="rpwn">窗口的名称</param>
        public static void RefreshParentWindow(string command, RefreshParentWindowName rpwn)
        {
            RequireWindowCommandScript();
            ...
            string script = string.Format("$HGRootNS.WindowCommand.openerExecuteCommand(\"{0}\", \"{1}\");",
                CheckScriptString(command),
                rpwn.ToString());
