CREATE TABLE [DE].[EntityMappingItemSnapshot]
(
 ...
 CONSTRAINT [PK_SchemaUser] PRIMARY KEY CLUSTERED 
(
	[ID] ASC,
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_EntityMappingItemSnapshot_RowID] ON [DE].[EntityMappingItemSnapshot] ([RowUniqueID])

GO

CREATE FULLTEXT INDEX ON [DE].[EntityMappingItemSnapshot]
    ([SearchContent] LANGUAGE 2052)
    KEY INDEX [IX_EntityMappingItemSnapshot_RowID]
    ON [DEFullTextIndex] WITH CHANGE_TRACKING AUTO

GO

CREATE INDEX [IX_EntityMappingItemSnapshot_StartTime] ON [DE].[EntityMappingItemSnapshot] ([VersionStartTime])
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level0name = N'DE',
    @level1type = N'TABLE',
    @level1name = N'EntityMappingItemSnapshot',
    @level2type = N'COLUMN',
    @level2name = N'ID'
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
