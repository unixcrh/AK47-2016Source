...
namespace MCS.Web.WebControls.Test.DeluxeTree
{
	public partial class SimpleTreeTest : System.Web.UI.Page
	{
		...
		{
			MCS.Web.WebControls.DeluxeTree tree = targetControl as MCS.Web.WebControls.DeluxeTree;

			if (tree != null)
			{
				tree.GetChildrenData += new WebControls.DeluxeTree.GetChildrenDataDelegate(tree_GetChildrenData);
			}
		}
		...
		private MCS.Web.WebControls.DeluxeTree CreateDynamicTree()
		{
			MCS.Web.WebControls.DeluxeTree tree = new WebControls.DeluxeTree();
